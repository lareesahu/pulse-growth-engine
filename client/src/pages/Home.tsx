    ...
    <div className="min-h-screen bg-background flex flex-col" style={{ marginTop: `${bannerHeight}px` }}>
      ...
      <header className="border-b border-border px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg flex items-center justify-center" style={{ background: "linear-gradient(135deg, #5E6AD2, #7C3AED)" }}>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center max-w-4xl mx-auto py-20">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full opacity-10" style={{ background: "radial-gradient(circle, #5E6AD2 0%, #5E6AD2 40%, transparent 70%)" }} />
        </div>
        ...
        <div className="relative">
          ...
          <h1 className="text-5xl font-bold text-foreground mb-4 leading-tight">
            Your autonomous<br />
            <span style={{ background: "linear-gradient(135deg, #5E6AD2, #7C3AED, #5E6AD2)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
          ...
          <Button asChild size="lg" className="text-base px-8 py-3" style={{ background: "linear-gradient(135deg, #5E6AD2, #7C3AED)" }}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-20 w-full">
          {[
            ...
            <div key={i} className="p-4 rounded-xl border border-border bg-card text-left">
              <div className="w-8 h-8 rounded-lg flex items-center justify-center mb-3 text-primary" style={{ background: "oklch(57% 0.16 270 / 0.15)" }}>
                {f.icon}
              </div>
