...
--> statement-breakpoint
ALTER TABLE `ideas` MODIFY COLUMN `funnelStage` enum('awareness','consideration','conversion','retention','decision') DEFAULT 'awareness';--> statement-breakpoint
ALTER TABLE `platform_variants` MODIFY COLUMN `platform` enum('instagram','facebook','linkedin','tiktok','webflow','medium','xiaohongshu','wechat','reddit','quora','blog') NOT NULL;--> statement-breakpoint
